...
import { MapPin, Navigation, Route, ArrowRight, CalendarClock, Users, Car } from 'lucide-react';
          ...
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-start space-x-2">
                ...
                <div>
                  <span className="text-xs text-muted-foreground uppercase">Schedule</span>
              ...
              <div className="flex items-start space-x-2">
                ...
                <div>
                  <span className="text-xs text-muted-foreground uppercase">Passengers</span>
                  <p className="text-sm">{passengers} passenger{passengers !== 1 ? 's' : ''}</p>
                </div>
              </div>
            ...
            {distance !== null && (
              <div className="p-3 bg-primary/5 rounded-md">
                <p className="text-xs text-center">
                  Fare estimate: <span className="font-semibold">LKR {(distance * (vehicleType === 'sedan' ? 100 : vehicleType === 'suv' ? 150 : vehicleType === 'van' ? 200 : 300) + (vehicleType === 'sedan' ? 200 : vehicleType === 'suv' ? 300 : vehicleType === 'van' ? 400 : 600)).toFixed(2)}</span>
                </p>
              </div>
            )}
          </div>
